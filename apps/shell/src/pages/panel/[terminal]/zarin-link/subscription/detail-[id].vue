...
// api
const { data, refetch, loading } = useZarinLinkSubscriptionQueryById();
// composable
...
// meta
definePageMeta({
  name: 'zarin-link-detailSubscription',
  layout: 'terminal',
  middleware: ['check-active-terminal'],
  fallbackRoute: '/zarin-link',
});
useHead({
  title: t('_common.page_title.donation_detail'),
});
