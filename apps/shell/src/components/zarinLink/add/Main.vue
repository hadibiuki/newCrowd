...
export type PaymentValuesType = Partial<{
  title: string;
  amount: string;
  description: string;
...
const { data, loading, refetch, onResult } = useZarinLinkPaymentQueryById();
...
const formValues: PaymentValuesType | undefined = inject('form_values');
